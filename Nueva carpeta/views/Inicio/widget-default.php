        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="image-container">
                    <img class="img-fluid" src="asset/images/intro-office.jpg" alt="alternative">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="asset/images/services-1.jpg" alt="alternative">
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="asset/images/services-2.jpg" alt="alternative">
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="asset/images/services-3.jpg" alt="alternative">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-12">
                ...
                <div class="grid">
                    <div class="element-item development">
                        <a class="popup-with-move-anim" href="#project-1"><div class="element-item-overlay"><span>Online Banking</span></div><img src="asset/images/project-1.jpg" alt="alternative"></a>
                    </div>
                    <div class="element-item development">
                        <a class="popup-with-move-anim" href="#project-2"><div class="element-item-overlay"><span>Classic Industry</span></div><img src="asset/images/project-2.jpg" alt="alternative"></a>
                    </div>
                    <div class="element-item design development marketing">
                        <a class="popup-with-move-anim" href="#project-3"><div class="element-item-overlay"><span>BoomBap Audio</span></div><img src="asset/images/project-3.jpg" alt="alternative"></a>
                    </div>
                    <div class="element-item design development marketing">
                        <a class="popup-with-move-anim" href="#project-4"><div class="element-item-overlay"><span>Van Moose</span></div><img src="asset/images/project-4.jpg" alt="alternative"></a>
                    </div>
                    <div class="element-item design development marketing seo">
                        <a class="popup-with-move-anim" href="#project-5"><div class="element-item-overlay"><span>Joy Moments</span></div><img src="asset/images/project-5.jpg" alt="alternative"></a>
                    </div>
                    <div class="element-item design marketing seo">
                        <a class="popup-with-move-anim" href="#project-6"><div class="element-item-overlay"><span>Spark Events</span></div><img src="asset/images/project-6.jpg" alt="alternative"></a>
                    </div>
                    <div class="element-item design marketing">
                        <a class="popup-with-move-anim" href="#project-7"><div class="element-item-overlay"><span>Casual Wear</span></div><img src="asset/images/project-7.jpg" alt="alternative"></a>
                    </div>
                    <div class="element-item design marketing">
                        <a class="popup-with-move-anim" href="#project-8"><div class="element-item-overlay"><span>Zazoo Apps</span></div><img src="asset/images/project-8.jpg" alt="alternative"></a>
                    </div>
                </div> <!-- end of grid -->
                <!-- end of filter -->
...
<div id="project-7" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
        <div class="col-lg-8">
            <img class="img-fluid" src="asset/images/project-7.jpg" alt="alternative">
        </div> <!-- end of col -->
        <div class="col-lg-4">
            <h3>Casual Wear</h3>
            <hr class="line-heading">
...
<div id="project-8" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="row">
        <button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
        <div class="col-lg-8">
            <img class="img-fluid" src="asset/images/project-8.jpg" alt="alternative">
        </div> <!-- end of col -->
        <div class="col-lg-4">
            <h3>Zazoo Apps</h3>
            <hr class="line-heading">
            ...
            <div class="col-lg-12">
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="asset/images/team-1.png" alt="alternative">
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="asset/images/team-2.png" alt="alternative">
                    </div> <!-- end of image wrapper -->
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="asset/images/team-3.png" alt="alternative">
                    </div> <!-- end of image wrapper -->
                ...
                <div class="team-member">
                    <div class="image-wrapper">
                        <img class="img-fluid" src="asset/images/team-4.png" alt="alternative">
                    </div> <!-- end of image wrapper -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-xl-6">
                <div class="image-container">
                    <img class="img-fluid" src="asset/images/about.jpg" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
