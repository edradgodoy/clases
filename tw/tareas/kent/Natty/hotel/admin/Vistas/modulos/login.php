...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="../../AdminLTE-2.4.2/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Barberia Ingram</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Ingreso al gestor del contenido</p>
