<section class="newsletter text-center py-5">
	<div class="container py-lg-3">
		...
		<div class="subscribe_inner">
			<h4 class="mb-4">Suscribite ya</h4>
			<p class="mb-4">Suscribite nuestra Sitio Web</p>
		...
		<div class="copyright mt-5">
			<p>© 2020 Barberia Kenji Reyes Ingram. En Bilwi Puerto Cabezas  <!--<a href="http://w3layouts.com/">W3layouts</a>--> </p>
		</div>
	</div>
</section>